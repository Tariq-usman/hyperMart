...
public class SubCategoryProductsFinalAdapter extends RecyclerView.Adapter<SubCategoryProductsFinalAdapter.FilterItemViewHolder> {
    Context context;
    String imagePath;
    private List<SubCategoryProductsFinalResponse.Products.Datum_> subCatergoryList;
    ...
    public SubCategoryProductsFinalAdapter(Context context, List<SubCategoryProductsFinalResponse.Products.Datum_> subCatergoryList) {
