...
public class AvailableItemsListSelectedStoreRadiusAdapter extends RecyclerView.Adapter<AvailableItemsListSelectedStoreRadiusAdapter.ItemsListViewHolder> {
    private List<SelectedStoreProductsResponse.Datum.Available> avail_items_list;
    Context context;
    ...
    public AvailableItemsListSelectedStoreRadiusAdapter(Context context, List<SelectedStoreProductsResponse.Datum.Available> avail_items_list, RecyclerClickInterface clickInterface) {
