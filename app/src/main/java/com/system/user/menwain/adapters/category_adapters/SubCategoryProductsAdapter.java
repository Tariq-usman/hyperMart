...
public class SubCategoryProductsAdapter extends RecyclerView.Adapter<SubCategoryProductsAdapter.FilterItemViewHolder> {
    Context context;
    String imagePath;
    List<SubCategoryResponse.Products.Datum_> subCatergoryList;
    ...
    public SubCategoryProductsAdapter(Context context, List<SubCategoryResponse.Products.Datum_> subCatergoryList) {
